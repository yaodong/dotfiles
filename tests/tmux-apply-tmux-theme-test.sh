...
assert_not_contains '@catppuccin_window_status_style' "$CAPTURED_TMUX_CONF"
assert_not_contains '@catppuccin_window_current_left_separator' "$CAPTURED_TMUX_CONF"
assert_not_contains '@catppuccin_window_current_middle_separator' "$CAPTURED_TMUX_CONF"
assert_not_contains '@catppuccin_window_current_right_separator' "$CAPTURED_TMUX_CONF"
...
assert_not_contains '@catppuccin_window_text' "$CAPTURED_TMUX_CONF"
assert_not_contains '@catppuccin_window_current_text' "$CAPTURED_TMUX_CONF"
assert_not_contains '@catppuccin_date_time_text' "$CAPTURED_TMUX_CONF"
